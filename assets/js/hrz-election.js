...
document.getElementById("form").addEventListener("submit", function (e) {
  ...
  fetch("https://api.ipify.org?format=json")
    ...
    .then((data) => {
      ...
      return fetch(
        "https://script.google.com/macros/s/AKfycbxyfp48gVc3rBcVV7aHppyYb9lqheyiGzQu5GVzVyC8qpdtbLOtaAOw_cxSvt1Xh-TT/exec",
        {
          redirect: "follow",
          method: "POST",
          body: formDataString,
    ...
    .then(function () {
      ...
      setTimeout(function () {
        window.location.href = "/election/general/hre";
      }, 500);
    })
